...
const EcosystemServices = () => {
  const ecosystems = [
  {
    ...
    organization: {
      name: 'FFS: Forest First Samithi (NGO)',
      url: 'https://forestfirstsamithi.org/'
    },
  ...
  },
  {
    ...
    organization: {
      name: 'Hasten Regeneration (NGO)',
      url: 'https://www.hastenregeneration.org/home'
    },
  ...
  },
  {
    ...
    organization: {
      name: 'ELF: The Eco-Logical Foundation (NGO)',
      url: 'https://ricesub.in/'
    },
  ...
  },
  {
    ...
    organization: {
      name: 'Earthyantra',
      url: 'https://wri-india.org/events/2022/7/land-accelerator-south-asia-cohort-2022'
    },
  ...
  <a 
    href={ecosystem.organization.url} 
    target="_blank" 
